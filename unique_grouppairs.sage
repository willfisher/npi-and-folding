...
'''
[[b, a*b, a^-1*b, a^2*b, a^-2*b, a^3*b, a^-3*b, a^4*b, a^-4*b, a^5*b, a^-5*b], No
 [a*b^2*a*b^-1, (a*b)^2*a*b^-1, a*b*a^-1*b*a*b^-1], Yes
 [a*b^2*a^-1*b^-1, (a*b)^2*a^-1*b^-1, a*(b*a^-1)^2*b^-1], No
 [a*b^-1*a^-1*b^2, a*b*a*b^-1*a^-1*b], No
 [a^-1*b^2*a^-1*b^-1, a*b*a^-1*b^-1*a^-1*b, (a^-1*b)^2*a^-1*b^-1], Yes
 [a^2*b^2*a*b^-1], No
 [a^2*b^2*a^-1*b^-1], Yes
 [a^2*b^-1*a*b^2], Yes
 [a^2*b^-1*a^-1*b^2], No
